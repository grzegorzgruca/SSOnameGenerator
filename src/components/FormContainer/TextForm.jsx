...
export default function TextForm(props) {
    return (<div className="flex flex-col items-center mt-4">
        ...
        <input value={props.inputVal} onChange={(e) => props.setInputVal(e.target.value)} className="w-96 mx-auto text-pink-300 my-4 border outline-pink-600 rounded-3xl indent-2 text-xl" id="wishText" type="text" placeholder="Np. dla białej maści"></input>
